...
func (x *HttpStatus) GetCode() uint32 {
	if x != nil {
		return x.Code
	}
	return 0
...
const file_envoy_type_v3_http_status_proto_rawDesc = "" +
	...
	"\n" +
	"HttpStatus\x12\x12\n" +
	"\x04code\x18\x01 \x01(\rR\x04codeB7Z5github.com/traefik/traefik/v3/pkg/proto/envoy/type/v3b\x06proto3"
...
var file_envoy_type_v3_http_status_proto_goTypes = []any{
	(*HttpStatus)(nil), // 0: envoy.type.v3.HttpStatus
}
